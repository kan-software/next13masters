...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ quantity: number, product?: { name: string, price: number, id: string, images: Array<{ url: string }>, categories: Array<{ name: string }> } | null }> } | null };
